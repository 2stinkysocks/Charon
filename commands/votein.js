module.exports = {
  ...
  execute(message, args) {
    ...
    if(message.guild.roles.cache.find(role => role.name == `vc list`).members > 0) message.channel.send({
      embed: {
        color: 4360181,
        title: `VC list`,
    ...
    if(message.guild.roles.cache.find(role => role.name == `sos list`).members > 0) message.channel.send({
      embed: {
        color: 4360181,
        title: `SOS list`,
        description: message.guild.roles.cache.find(role => role.name == `sos list`).members.map(m => m.user.tag).join('\n')
    ...
    if(message.guild.roles.cache.find(role => role.name == `rsvd list`).members > 0) message.channel.send({
      embed: {
        color: 4360181,
        title: `RSVD list`,
    ...
    if(message.guild.roles.cache.find(role => role.name == `void list`).members > 0) message.channel.send({
      embed: {
        color: 4360181,
        title: `Void list`,
    ...
    if(message.guild.roles.cache.find(role => role.name == `allies list`).members > 0) message.channel.send({
      embed: {
        color: 4360181,
        title: `Allies list`,
    ...
    if(message.guild.roles.cache.find(role => role.name == `fill list`).members > 0) message.channel.send({
      embed: {
        color: 4360181,
        title: `Fill list`,
